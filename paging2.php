...
group by a.id "; //$hab*/
$count="select count( c.id), b.nombre as aseg,c.nombre as usu,c.usuario, c.ciudad,c.postal,a.nombre as pais from aseguradora b, usuario c,paises a where a.id = c.pais and c.empresa= b.id and c.sts in ('ENV', 'RCH')"; //$hab
/*
...
from aseguradora b, usuario c,paises a where a.id = c.pais and c.empresa= b.id and c.sts in ('ENV', 'RCH')"; // 
...
//echo $total;
  echo"<br> <a href = 'crearUsuarios.php' style= 'color: #4E66F8;'> Agregar Usuarios </a> <br> <a href = 'UsuariosApr.php' style= 'color: green;'> Ver Usuarios Aprobados</a>";
  ...
  while($row = $c->fetch_array(MYSQLI_ASSOC))
  {
    ...
    //$ubi = $row["ubicacion"];
        ...
        $sts = $row["sts"];
        if($sts == 'ENV'){
          $sts2 = " <td align = 'center' style = 'color:blue;'>En Espera </td>";
        }
         if($sts == 'RCH'){
        ...
        echo" 
         ...
         <td align = 'center'> $fec</td>
           $sts2";
         if($sts == 'ENV'){
       echo" <td align = 'center'> <a href = 'edit3.php?caso=$caso&acc=acp' style= 'color: #4E66F8;'> Aprobar</a>  &nbsp; &nbsp; <a href = 'edit3.php?caso=$caso&acc=neg' style= 'color: red;'> Rechazar</a> </td> ";
            }
             if($sts == 'RCH'){
            echo" <td align = 'center'> <a href = 'edit3.php?caso=$caso&acc=acp' style= 'color: #4E66F8;'> Aprobar</a>  &nbsp; &nbsp; </td>";
            }
         echo" </tr>";
