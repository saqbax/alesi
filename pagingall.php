...
where a.id_aseg = b.id and a.id_usuario = c.id and a.sts in ('ENV', 'RCH','ELA' ,'APR') and b.id = $id $liy"; //$hab
...
from caso a, aseguradora b, usuario c
where a.id_aseg = b.id and a.id_usuario = c.id and a.sts in ('ENV', 'RCH','ELA', 'APR') and b.id = $id $liy"; // 
...
//echo $total;
  ...
  while($row = $c->fetch_array(MYSQLI_ASSOC))
  {
    ...
    //$ubi = $row["ubicacion"];
       ...
       if(($sts == 'ENV') and ($usug == '1')){
          echo"<td><a href = 'editar.php?caso=$caso' style= 'color: #4E66F8;'>Editar</a>  &nbsp; &nbsp; &nbsp; <a href = 'edit5.php?caso=$caso&id=$id' style= 'color: red;'>Devolver</a></td>";
        }
        
       else{
        if((($sts == 'ENV')  and ($usug != '1')) or ($sts == 'APR')){
          if($pizarra == '1'){
          echo"<td> </td>";}
          else{
            echo"<td><a href = 'editar.php?caso=$caso' style= 'color: #4E66F8;'>Editar</a>  </td>"; 
          }
