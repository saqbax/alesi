...
Pizarra de trabajo</h2>
        ...
        <div class="row">
          ...
          <div class="col-xl-9 mx-auto"> 
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    <h6 class="mb-4">Pîzarra de César Quiñones</h6>
...
<?php 
                      ...
                      <!--data-toggle="tab" #tab1-content -->
          <li class="nav-item"><a id="tab1"  href = "<?php echo $klo;?>" role="tab" aria-controls="tab1-content" 
                        aria-selected="false" class="nav-link">Pizarra</a></li>
                      <li class="nav-item"><a id="tab2"  href="abrirCaso.php" role="tab" aria-controls="tab2-content" aria-selected="false" class="nav-link">Crear Nuevo Caso</a></li>
                               <?php if($usug =='1'){ ?>
                      <li class="nav-item"><a id="tab3"  href="Usuarios.php" role="tab" aria-controls="tab3-content" aria-selected="false" class="nav-link">Validar Usuarios</a></li>
            <li class="nav-item"><a id="tab4" href="Aseguradora.php" role="tab" aria-controls="tab4-content" aria-selected="false" class="nav-link">Validar Aseguradoras</a></li> <?php } 
            else{?>
               <li class="nav-item"><a id="tab3" href="#" role="tab" aria-controls="tab3-content" aria-selected="false" class="nav-link">Alertas</a></li>
            <li class="nav-item"><a id="tab4" href="#" role="tab" aria-controls="tab4-content" aria-selected="false" class="nav-link">Entregados</a></li>
              ...
              $sq3l= "select * from aseguradora where id not in ('3') and sts ='APR'";
                    $rc3 = mysqli_query($mysql,$sq3l);
                      while($row = mysqli_fetch_array($rc3)){
                        ...
                        $nombre3 = $row["nombre"];
                        if($id == $id3){
                            $vart = " aria-selected='true' class='nav-link active'";
                              }
                              else{
                                 $vart = " aria-selected='false' class='nav-link'";
                              }
                         echo"<li class='nav-item'><a id='tab5' href ='Empresa.php?id=$id3' role='tab' aria-controls='tab5-content' $vart>$nombre3</a></li>";
                        }
            ?>
            <li class="nav-item"><a id="tab2"  href="Archivos.php" role="tab" aria-controls="tab2-content" aria-selected="false" class="nav-link"> Archivos</a></li>
