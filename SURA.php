...
Pizarra de trabajo</h2>
        ...
        <div class="row">
          ...
          <div class="col-xl-9 mx-auto"> 
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    <h6 class="mb-4">Pîzarra de Usuario "N" SURA</h6>
                    <ul id="myTab" role="tablist" class="nav nav-tabs">
                      ...
                      <li class="nav-item"><a id="tab2" data-toggle="tab" href="#tab2-content" role="tab" aria-controls="tab2-content" aria-selected="false" class="nav-link">Alertas</a></li>
                      <li class="nav-item"><a id="tab3" data-toggle="tab" href="#tab3-content" role="tab" aria-controls="tab3-content" aria-selected="false" class="nav-link">Salir</a></li>
                    ...
                    <div class="tab-content py-5 px-3">
                      <div id="tab1-content" role="tabpanel" aria-labelledby="tab1-content" class="tab-pane fade show active">
                        <p class="text-muted">Mi estimado Julio, porfavor deposita aqui las tablas de la pizarra para las Aseguradoras</p>
                      </div>
                      <div id="tab2-content" role="tabpanel" aria-labelledby="tab2-content" class="tab-pane fade">
                        <p class="text-muted">Aqui las alertas emitidas por el Master</p>
                      </div>
                      <div id="tab3-content" role="tabpanel" aria-labelledby="tab3-content" class="tab-pane fade">
                        <p class="text-muted">Despedida y salida de la plataforma</p>
                      </div>
