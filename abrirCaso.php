                ...
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <ul id="myTab" role="tablist" class="nav nav-tabs">
                      ...
                      <li class="nav-item"><a id="tab2"  href="abrirCaso.php" role="tab" aria-controls="tab2-content" aria--selected="true" class="nav-link active">Crear Nuevo Caso</a></li>
                      <?php if($usug =='1'){ ?>
