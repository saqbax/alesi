...
Pizarra de trabajo</h2>
        ...
        <div class="row">
          ...
          <div class="col-xl-9 mx-auto"> 
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <ul id="myTab" role="tablist" class="nav nav-tabs">
                      ...
                      <li class="nav-item"><a id="tab1"  href="bienvenido.php" role="tab" aria-controls="tab1-content" 
                        -selected="false" class="nav-link">Pizarra</a></li>
                      ...
                      <li class="nav-item"><a id="tab3"  href="Usuarios.php" role="tab" aria-controls="tab3-content" aria--selected="false" class="nav-link">Validar Usuarios</a></li>
						<li class="nav-item"><a id="tab4"  href="Aseguradora.php" role="tab" aria-controls="tab4-content" aria-selected="false" class="nav-link">Validar Aseguradoras</a></li>
					 <?php 
            ...
            ?>
            <li class="nav-item"><a id="tab2"  href="Archivos.php" role="tab" aria-controls="tab2-content" aria-selected="true" class="nav-link active"> Archivos</a></li>
                    </ul>
                    <div class="tab">
                     
                      <div id="tab2-content" role="tabpanel" aria-labelledby="tab2-content" class="tab-pane fade show active">
                        <!--<p class="text-muted">Crear un nuevo Documento</p> -->

                        <?php //include("crear.php"); ?>
                        <br> <br>
                        
                        <form action= "docenv.php" method="POST" enctype="multipart/form-data" >		
											
										
						
						<label for="text">Seleccione el Caso</label> <br>
						<select id = "iddependencia" class = "form-control" name = "iddependencia" required = "required">
						    <option value = ''>.: Seleccione un Caso :.</option>
								<?php
									$sql3= "SELECT a.id, a.poliza, a.siniestro, b.nombre FROM caso a, aseguradora b where a.id_aseg = b.id ";

									$titular=mysqli_query($mysql,$sql3);
									while ($row = mysqli_fetch_array($titular)){								
										$ndep = $row["nombre"];
										$id = $row["id"];
										$pol = $row["poliza"];
										$sin = $row["siniestro"];
										echo" <option value = '$id'><b>Caso:</b> $id - <b>Aseg.:</b>$ndep - <b>P&oacute;liza:</b> $pol - <b>Siniestro:</b>$sin</option>";
									}
								?>
							</select>
						...
						<label><i>Adjuntar archivo</i></label> <br>
							<input type="file" name="doc[]"  required= '' value="" multiple > <br> <br>
							<input name="submit" type="submit" value="ENVIAR" class="btn btn-primary col-md-5" > 	<br>
